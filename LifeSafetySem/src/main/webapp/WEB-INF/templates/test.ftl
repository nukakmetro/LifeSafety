...
<head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <meta name="description" content="Пример на bootstrap 5: Форма входа - макет и дизайн формы · Версия v5.3.1">
    <title>Форма входа | Signin Template for Bootstrap · Версия v5.3.1</title>

    <link rel="canonical" href="https://bootstrap-5.ru/docs/5.3/examples/sign-in/">
